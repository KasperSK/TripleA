...
Her kan det ses at attributterne i klasse modellen minder meget om kolonerne i tabellerne, med nogle få forskelle. En lille ting man kan ligge mærke til er at PaymentType\fxnote{glossery} og Status\fxnote{glossery} er gemt som integer, da navne på dem er gemt i nogle enums inde i C\# koden. 
\newline\newline
